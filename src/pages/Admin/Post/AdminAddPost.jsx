...
import { getAllListActivePostCat } from '../../../redux/reducers/PostCatReducer';
const { Option } = Select;
...
export default function AdminAddPost() {
    const { allListActivePostCats } = useSelector(state => state.PostCatReducer);
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            dispatch(addPost(formData)); //formData
        },
    });
    ...
    const renderOptions = () => {
        return allListActivePostCats?.map((postCat, index) => {
