...
import { editProductCat } from '../../../redux/reducers/ProductCatReducer';
import { setVisibleFalseAction } from '../../../redux/reducers/DrawerReducer';
export default function AdminEditProductCat() {
    const { detailProductCat } = useSelector(state => state.ProductCatReducer);
    const dispatch = useDispatch();
    const formik = useFormik({
        enableReinitialize: true,
        initialValues: {
            id: detailProductCat?.id,
            name: detailProductCat?.name,
            status: detailProductCat?.status,
        },
        ...
        onSubmit: values => {
            dispatch(editProductCat(values));
        },
    });
